              ...
              {:else if e.type === "personaliseTop"}
                ...
                <div>
                  ...
                  <div class="bgBox">
                    ...
                    />
                    <img
                      src="assets/Wallpaper/Windows/img19.jpg"
                      alt=""
                      height="75"
                      width="120"
                    />
                    <img
                      src="assets/Wallpaper/Glow/img20.jpg"
                      alt=""
                      height="75"
                      width="120"
                    />
                    <img
                      src="assets/Wallpaper/Captured Motion/img24.jpg"
                      alt=""
                      height="75"
                      width="120"
                    />
                    <img
                      src="assets/Wallpaper/Sunrise/img28.jpg"
                      alt=""
                      height="75"
                      width="120"
                    />
                    <img
                      src="assets/Wallpaper/Flow/img32.jpg"
                      alt=""
                      height="75"
                      width="120"
                    />
